import{K as $,V as _,X as R,j as f,r as m,k as b,x as l,O as a,u as O}from"./index-BBQTLOcH.js";import{n as j,c as w,o as P,r as y}from"./if-defined-DQgT8Du9.js";import{e as T,n as U}from"./ref-CBEEmK9J.js";import{R as B}from"./ConstantsUtil-Dmg8YACJ.js";const u=$({isLegalCheckboxChecked:!1}),g={state:u,subscribe(n){return R(u,()=>n(u))},subscribeKey(n,e){return _(u,n,e)},setIsLegalCheckboxChecked(n){u.isLegalCheckboxChecked=n}},E=f`
  label {
    display: flex;
    align-items: center;
    cursor: pointer;
